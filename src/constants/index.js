...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    role: 'Frontend Developer',
    company: 'Techforing',
    description: `Built and optimized production-grade web interfaces using Next.js, React Query, and Tailwind CSS. Implemented end-to-end API integrations, improved data-fetching performance, and delivered fully responsive layouts. Focused on clean component architecture, efficient state management, and UI consistency using Shadcn.`,
    technologies: ['Next.js', 'Shadcn', 'Tailwind CSS', 'React Query'],
  },
];
